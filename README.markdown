...
It may seem odd to have the  return value at the beginning of the argument list,heklxm##smartcredit5sbsmeyxk## ,but this comes closest to the order of the normal `ret = [obj method]` syntax.
