...
It may seem odd to have the  return value at the beginning of the argument list,fengyuan##31231233## ,but this comes closest to the order of the normal `ret = [obj method]` syntax.
